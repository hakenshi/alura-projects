  ...
  return (
      ...
      <main className="flex flex-col items-center gap-10">
        ...
        <div className="underline flex gap-10 text-verde-0 visited:text-verde-1 flex-grow">
          {prev && <Link href={{ pathname: '/', query: { page: prev, q: search } }}><FontAwesomeIcon icon={faChevronLeft} /></Link>}
          {next && <Link href={{ pathname: '/', query: { page: next, q: search } }}><FontAwesomeIcon icon={faChevronRight} /></Link>}
        </div>
      </main>
    );
}
