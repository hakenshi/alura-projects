    ...
    return (
        <main className='max-w-screen-lg flex flex-col items-center gap-10'>
            <div className='flex flex-col w-full gap-10'>
                ...
                <div className='bg-cinza-500 p-5 rounded-xl text-cinza-200 max-h-64 overflow-y-scroll'
                     dangerouslySetInnerHTML={{__html: post.markdown}}></div>
            </div>
            {post.comments.length > 0 && <div
                className='bg-cinza-300 text-black rounded-xl w-full max-h-[839px] overflow-y-clip px-7 py-10 text-2xl font-semibold'>
                <h2>Comentários</h2>
